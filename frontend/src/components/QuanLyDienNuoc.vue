...
.btn-teal { background-color: #2E6E7E; color: #fff; border: none; transition: 0.25s; border-radius: 8px; }
.btn-teal:hover { background-color: #00C4A0; color: #141414; }
.text-teal { color: #00C4A0; }
.bg-teal-light { background-color: #e0f8f4; }

.service-badge { font-weight: 700; font-size: 13px; }
.service-dien { color: #d97706; }
.service-nuoc { color: #0891b2; }
.service-box { border: 2px solid; }
.service-box-dien { border-color: #fde68a; background-color: #fffbeb; }
.service-box-nuoc { border-color: #a5f3fc; background-color: #f0f9ff; }
...
.modal-content { width: 90%; max-width: 620px; animation: slideDown 0.3s ease-out; }
